...
<body>
    ...
    <main>
        ...
        <div id="test-debug-link" style="display:none; margin-top: 20px; text-align: center;">
            <a href="/debugroom/" style="color: #007bff; text-decoration: none;">デバッグルーム</a>
        </div>
    </main>
    ...
    document.addEventListener('keydown', function(event) {
        if (event.ctrlKey && event.shiftKey && event.code === 'KeyQ') {
            ...
            selects.forEach(function(select) {
                const option1 = Array.from(select.options).find(function(option) {
            ...
            const debugLink = document.getElementById('test-debug-link');
            if (debugLink) {
