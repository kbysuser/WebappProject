...
// フォームからデータを取得
$postDataExists = $_SERVER['REQUEST_METHOD'] === 'POST' && !empty($_POST);
$username = $postDataExists ? ($_POST["username"] ?? "") : "";
$questionId = $postDataExists ? ($_POST["questionId"] ?? "") : "";
$answer = $postDataExists ? ($_POST["answer"] ?? "") : "";
$comment = $postDataExists ? ($_POST["comment"] ?? "") : "";
...
// submit.php から JavaScript リダイレクトで到達する場合、POST データはありません。
// result.php は完了ページとして表示するだけにしています。
?>
<!DOCTYPE html>
<html lang="ja">
